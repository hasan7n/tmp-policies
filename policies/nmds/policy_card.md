...
|---------|------------|-------------------------------|----------|--------------------------------------------------------|
| 1.0.0   | 2026-07-15 | Policy Fabric reference impl. | released | Initial policy card authored from the NMDS policy.     |
...
implementation of the DUO_0000015 (NMDS) data-use constraint, provided as-is. The
