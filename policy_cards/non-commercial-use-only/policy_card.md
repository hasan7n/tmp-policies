...
|---------|------------|-------------------------------|----------|--------------------------------------------------------|
| 1.0.0   | 2026-07-15 | Policy Fabric reference impl. | released | Initial policy card authored from the NCU policy.      |
...
implementation of the DUO_0000046 (NCU) data-use constraint, provided as-is. The
