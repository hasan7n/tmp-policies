...
|---------|------------|-------------------------------|----------|--------------------------------------------------------|
| 1.0.0   | 2026-07-15 | Policy Fabric reference impl. | released | Initial policy card authored from the DS policy.       |
...
implementation of the DUO_0000007 (DS) data-use constraint, provided as-is. The
