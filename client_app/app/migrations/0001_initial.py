    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ledger_url",
                    models.CharField(default="http://127.0.0.1:6600", max_length=200),
                ),
                (
                    "asset_registry_url",
                    models.CharField(default="http://127.0.0.1:8001", max_length=200),
                ),
                (
                    "template_registry_url",
                    models.CharField(default="http://127.0.0.1:8002", max_length=200),
                ),
